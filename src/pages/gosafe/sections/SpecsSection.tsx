...
const SpecsSection = ({ isDark, primaryColor, secondaryColor }: SpecsSectionProps) => {
  ...
  const getTabsData = (intl: IntlShape) => {
        ...
        specs: [
          {
            ...
            value: intl.formatMessage({ id: 'gosafe-specs-value-seamless', defaultMessage: 'Hoạt động liền mạch với G737' })
          },
          {
          ...
          },
          {
            ...
            value: intl.formatMessage({ id: 'gosafe-specs-value-send-g737', defaultMessage: 'Gửi đến G737' })
          }
        ]
      }
    ];
    ...
    return [
      {
        label: intl.formatMessage({ id: 'gosafe-specs-tab-tracker', defaultMessage: 'G737 Tracker' }),
