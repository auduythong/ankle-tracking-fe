...
const getProducts = (intl: IntlShape): Product[] => [
  {
    id: 'g737',
    name: intl.formatMessage({ id: 'gosafe-product-g737-name', defaultMessage: 'G737 Tracker' }),
  ...
  {
    id: 'beacon',
    name: intl.formatMessage({ id: 'gosafe-product-beacon-name', defaultMessage: 'GIB737 Home Beacon' }),
    ...
    description: intl.formatMessage({
      ...
      defaultMessage:
        'Device supporting indoor positioning, helping G737 monitor more accurately when the offender is in areas without GPS.'
    }),
    ...
    details: [
      ...
      },
      {
        ...
        content: intl.formatMessage({
          ...
          defaultMessage: 'Gửi ngay tới G737 khi beacon bị tháo/gỡ.'
        }),
        icon: <ShieldSecurity size={32} variant="Bold" />,
  ...
  {
    id: 'powerbank',
    name: intl.formatMessage({ id: 'gosafe-product-powerbank-name', defaultMessage: 'G737P-PB' }),
    ...
    description: intl.formatMessage({
      ...
      defaultMessage: 'High-performance power bank, extending the operating time of G737 monitoring device in harsh environments.'
    }),
